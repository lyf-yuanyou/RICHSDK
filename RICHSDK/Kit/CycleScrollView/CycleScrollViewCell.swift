...
class CycleScrollViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        titleBackView.frame = CGRect(x: 0, y: frame.height - titleLabelHeight, width: frame.width, height: titleLabelHeight)
        titleLabel.frame = CGRect(x: titleLabelLeading, y: 0, width: frame.width - titleLabelLeading - 5, height: titleLabelHeight)
    }
}
